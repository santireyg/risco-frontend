    ...
    <Card shadow="sm" className="overflow-hidden">
      ...
      <CardBody className="p-6">
        <div className="mb-4 flex flex-wrap items-center gap-2 text-sm text-gray-500">
          <span>Fuente:</span>
          <Chip variant="bordered" radius="sm" size="sm" className="border border-slate-300 text-slate-500">
        ...
        <div className="relative">
          <div
            ...
            <section>
              <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-900 mb-2">Contexto General</h3>
              <p className="text-[15px]">{analisisTexto.introduccion}</p>
            </section>

            <section>
              <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-900 mb-2">Situación Financiera</h3>
            ...
            <section className="border-t border-gray-200 pt-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-900 mb-2">Conclusión y Recomendación</h3>
