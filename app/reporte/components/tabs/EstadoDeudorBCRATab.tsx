...
import type { ChequesRechazados, DebtEntity, DebtHistory, DebtPeriod } from "../../types";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="border border-slate-200 rounded-lg p-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-xs text-gray-600">{formatSituacionDescriptionText(situacionGeneral)}</div>
                  </div>
                </div>
                <div className="border border-slate-200 rounded-lg p-4">
