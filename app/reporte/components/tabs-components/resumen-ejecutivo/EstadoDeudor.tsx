...
export default function EstadoDeudor({ data }: EstadoDeudorProps) {
  ...
  const getSituacionChip = (sit: number) => {
    if (sit === 0)
      return { text: "Situación 0 - Sin deuda", color: "default" as const };
    if (sit === 1)
      return { text: "Situación 1 - Normal", color: "success" as const };
    if (sit === 2)
      return { text: "Situación 2 - Con problemas", color: "warning" as const };
