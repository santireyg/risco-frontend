          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-col gap-3">
              <div className="flex items-center  sm:gap-3">
                ...
                <h1 className="text-4xl font leading-tight text-slate-900">
                  {companyInfo.company_name}
                </h1>
              </div>
              <div className="flex flex-col gap-2 text-sm text-slate-500">
                <div className="flex items-center gap-2">
                  <span className="text-xs uppercase tracking-[0.10em] text-slate-400">
                    CUIT:
                  </span>
                  <span className="text-slate-500 font-light">
                    {formatCUIT(companyInfo.company_cuit)}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs uppercase tracking-[0.10em] text-slate-400">
            ...
            <div className="flex flex-col items-start gap-3 lg:items-end">
              <div className="inline-flex flex-col overflow-hidden rounded-lg border border-slate-200 shadow-sm text-sm text-slate-600 sm:flex-row">
                <div className="flex items-center bg-slate-100 px-4 text-xs font-medium text-slate-600">
                  Fecha del reporte
                </div>
              ...
              <div className="inline-flex flex-col overflow-hidden rounded-md border border-slate-200 shadow-sm text-sm text-slate-600 sm:flex-row">
                <div className="flex items-center bg-slate-100 px-4 py-2 text-xs font-medium text-slate-600">
                  Balance
                </div>
