...
export default function ReportePage() {
  ...
  const deudasHistoria = {
    ...
    results: {
      ...
      periodos: [
        reporteData.bcra_data.deudas_ultimo_periodo,
        ...reporteData.bcra_data.deudas_historia,
      ],
    },
  };
      ...
      <div className="border-t border-slate-200 bg-slate-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto items-center pt-8">
          ...
          <CompanyHeader
            ...
            balanceDatePrevious={
              reporteData.statement_data.statement_date_previous.$date
            }
                ...
                <SituacionFinancieraTab
                  estadosContables={{
                    ...
                    balance_date_previous:
                      reporteData.statement_data.statement_date_previous,
                    company_info: reporteData.company_info,
                    balance_data: {
                      resultados_principales: (() => {
                        const balanceItems =
                          reporteData.statement_data.balance_data
                            .resultados_principales;
                        const disponibilidades = findBalanceItem(
                          balanceItems,
                          "disponibilidades",
                        );
                        const bienesCambio = findBalanceItem(
                          balanceItems,
                          "bienes_de_cambio",
                        );
                        const activoCorriente = findBalanceItem(
                          balanceItems,
                          "activo_corriente",
                        );
                        ...
                        const activoTotal = findBalanceItem(
                          balanceItems,
                          "activo_total",
                        );
                        const pasivoCorriente = findBalanceItem(
                          balanceItems,
                          "pasivo_corriente",
                        );
                        ...
                        const pasivoTotal = findBalanceItem(
                          balanceItems,
                          "pasivo_total",
                        );
                        const patrimonioNeto = findBalanceItem(
                          balanceItems,
                          "patrimonio_neto",
                        );
                      ...
                      resultados_principales: (() => {
                        const incomeItems =
                          reporteData.statement_data.income_statement_data
                            .resultados_principales;
                        const ingresosVenta = findBalanceItem(
                          incomeItems,
                          "ingresos_por_venta",
                        );
