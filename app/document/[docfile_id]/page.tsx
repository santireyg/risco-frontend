...
const DocumentsPage: React.FC = () => {
  ...
  return (
    <div>
      <div className="max-w-screen-2xl container mx-auto flex items-center h-14 pl-5">
          ...
          <PanelGroup orientation="horizontal">
            ...
            <Panel defaultSize={DEFAULT_LEFT_PANEL_SIZE} minSize={MIN_LEFT_PANEL_SIZE}>
              <div className="h-full">
                <ScrollShadow className="pl-5 pr-8 pb-10 pt-3 overflow-y-auto max-h-[calc(100vh-8.5rem-2px)]" size={50}>
                  ...
                  {hasValidationAndStatus && !isSinDatos && !isProcesando && (
                    <>
                      ...
                      {activeTab === "balance_sheet" && editableDocument?.balance_data?.resultados_principales && (
                        <>
                          <h2 className="font-base  uppercase text-gray-400 mb-4 mt-7  pl-4 tracking-wide">
                          ...
                          <h2 className="font-base  uppercase text-gray-400 mb-4 mt-7 pl-4 tracking-wide">Detalle del Activo</h2>
                          ...
                          <h2 className="font-base  uppercase text-gray-400 mb-4 mt-7 pl-4 tracking-wide">Detalle del Pasivo</h2>
