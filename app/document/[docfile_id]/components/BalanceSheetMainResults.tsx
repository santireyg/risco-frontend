// ruta: app/document/[docfile_id]/components/BalanceSheetMainResults.tsx
...
interface BalanceSheetMainResultsProps {
  resultadosPrincipales: BalanceItem[];
  isEditing: boolean;
  setResultadosPrincipales: (data: BalanceItem[]) => void;
}
...
const BalanceSheetMainResults: React.FC<BalanceSheetMainResultsProps> = ({
  ...
  return (
    <div className="mt-4">
      <Table shadow="sm" aria-label="Resultados principales">
        <TableHeader>
...
export default BalanceSheetMainResults;
